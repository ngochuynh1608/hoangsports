<?php
// Heading
$_['heading_title']     = 'EXCEL Import';

// Text
$_['text_success']      = 'Success: You have successfully imported your products!';

// Entry
$_['entry_description'] = 'Use this function to import your products from a XLSX spreadsheet file.';

// Error
$_['error_permission']          = 'Warning: You do not have permission to modify imports!';
$_['error_upload']              = 'Uploaded file is not a valid spreadsheet file!';
