...
class ControllerProductLatest extends Controller {
	public function index() {
		...
		$this->document->setTitle('Đồ thể thao đà nẵng');
		...
		$results = $this->model_catalog_product->getProducts($filter_data);
			...
			$data['results'] = sprintf($this->language->get('text_pagination'), ($products_total) ? (($page - 1) * $limit) + 1 : 0, ((($page - 1) * $limit) > ($products_total - $limit)) ? $products_total : ((($page - 1) * $limit) + $limit), $products_total, ceil($products_total / $limit));
