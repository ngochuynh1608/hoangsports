	...
	public function index() {
		...
		foreach ($categories as $category) {
			if ($category['top']) {
                ...
                $image2="";
				if ($category['image']) {
					$image2 = $this->model_tool_image->resize($category['image'], 220,350);
				} else {
        ...
        $data['guide_href'] = $this->url->link('information/information', 'information_id=6');
        $data['km_href'] = $this->config->get('config_url') .'san-pham-khuyen-mai.html';
        $data['news_href'] = $this->config->get('config_url') .'tin-tuc.html';
        $data['contact_href'] = $this->config->get('config_url') .'lien-he.html';
        $data['landing_href'] = $this->url->link('information/information', 'information_id=7');
		$data['checkout'] = $this->url->link('checkout/checkout', '', 'SSL');
